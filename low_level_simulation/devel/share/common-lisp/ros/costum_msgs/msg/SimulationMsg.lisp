...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SimulationMsg>)))
  ...
  "1fc04017a8937851069ea4d1e0d47bfe")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SimulationMsg)))
  "Returns md5sum for a message object of type 'SimulationMsg"
  "1fc04017a8937851069ea4d1e0d47bfe")
