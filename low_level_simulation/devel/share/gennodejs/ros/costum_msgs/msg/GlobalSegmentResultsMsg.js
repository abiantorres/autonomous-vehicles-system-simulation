...
class GlobalSegmentResultsMsg {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GlobalSegmentResultsMsg
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GlobalSegmentResultsMsg
    let len;
    let data = new GlobalSegmentResultsMsg(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GlobalSegmentResultsMsg(null);
...
module.exports = GlobalSegmentResultsMsg;
