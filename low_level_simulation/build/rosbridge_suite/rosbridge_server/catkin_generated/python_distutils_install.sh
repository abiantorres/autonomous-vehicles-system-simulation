...
echo_and_run cd "/home/parallels/tfg/autonomous-vehicles-system-simulation/low_level_simulation/src/rosbridge_suite/rosbridge_server"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/parallels/tfg/autonomous-vehicles-system-simulation/low_level_simulation/src/rosbridge_suite/rosbridge_server/setup.py" \
    build --build-base "/home/parallels/tfg/autonomous-vehicles-system-simulation/low_level_simulation/build/rosbridge_suite/rosbridge_server" \
    install \
    $DESTDIR_ARG \
