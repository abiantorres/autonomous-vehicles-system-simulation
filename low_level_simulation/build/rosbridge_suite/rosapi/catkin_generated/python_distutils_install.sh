...
echo_and_run cd "/home/parallels/tfg/autonomous-vehicles-system-simulation/low_level_simulation/src/rosbridge_suite/rosapi"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/parallels/tfg/autonomous-vehicles-system-simulation/low_level_simulation/src/rosbridge_suite/rosapi/setup.py" \
    build --build-base "/home/parallels/tfg/autonomous-vehicles-system-simulation/low_level_simulation/build/rosbridge_suite/rosapi" \
    install \
    $DESTDIR_ARG \
