...
if("FALSE" STREQUAL "TRUE")
  set(rosauth_SOURCE_PREFIX /home/parallels/tfg/autonomous-vehicles-system-simulation/low_level_simulation/src/rosauth)
  set(rosauth_DEVEL_PREFIX /home/parallels/tfg/autonomous-vehicles-system-simulation/low_level_simulation/devel)
  set(rosauth_INSTALL_PREFIX "")
  set(rosauth_PREFIX ${rosauth_DEVEL_PREFIX})
else()
  set(rosauth_SOURCE_PREFIX "")
  set(rosauth_DEVEL_PREFIX "")
  set(rosauth_INSTALL_PREFIX /home/parallels/tfg/autonomous-vehicles-system-simulation/low_level_simulation/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosauth' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/parallels/tfg/autonomous-vehicles-system-simulation/low_level_simulation/install/${idir}'.  ${_report}")
    endif()
