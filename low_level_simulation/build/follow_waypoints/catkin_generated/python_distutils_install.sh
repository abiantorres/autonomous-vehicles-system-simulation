...
echo_and_run cd "/home/parallels/tfg/autonomous-vehicles-system-simulation/low_level_simulation/src/follow_waypoints"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/parallels/tfg/autonomous-vehicles-system-simulation/low_level_simulation/src/follow_waypoints/setup.py" \
    build --build-base "/home/parallels/tfg/autonomous-vehicles-system-simulation/low_level_simulation/build/follow_waypoints" \
    install \
    $DESTDIR_ARG \
