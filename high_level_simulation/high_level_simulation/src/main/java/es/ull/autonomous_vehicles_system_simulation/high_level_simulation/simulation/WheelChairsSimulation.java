...
public class WheelChairsSimulation extends Simulation {
	 ...
	 * DEFAULT CONSTRUCTOR *
	 **********************/
	public WheelChairsSimulation(Integer id, Integer nJanitors, Integer nDoctors, Integer nAutoChairs, 
			Integer nManualChairs, Integer patientsPerArrival, Integer minutesBetweenArrivals, 
		...
		final SimulationPeriodicCycle arrivalCycle = new SimulationPeriodicCycle(unit, 0, 
				...
				(int)(getLastArrival(startTime, endTime) / (minutesBetweenArrivals * 60)));
