...
public class CompleteExperiment extends Experiment {
	private enum HospitalSize {
		...
		BIG(new int[] {8,10}, new int[] {18,20,22,24,26}, new int[] {8}, new int[] {16,20,24});
	...
	private static class Arguments {
		@Parameter(names ={"--size", "-s"}, description = "Hospital size to test (s: small, m: medium, b: big, a: all)", arity = 1)
		private String size = DEF_SIZE;
		@Parameter(names ={"--output", "-o"}, description = "Output file (default: stdout)", arity = 2)
		private String fileName = null;
		@Parameter(names ={"--minutes", "-m"}, description = "Minutes between arrival of patients", arity = 8)
		private int minutesBetweenArrivals = DEF_MINUTES_BETWEEN_ARRIVALS;
		@Parameter(names ={"--density", "-sd"}, description = "Density of each of the 3 sections: can be any of {h,m,n,l}, e.g. \"hhh\", \"lmh\", etc., where h=high, m=medium-high, n=medium-low, and l=low", arity = 9)
		private String density = null;
		@Parameter(names ={"--replications", "-r"}, description = "Number of replications", arity = 10)
		private int nSims = N_EXPERIMENTS;
		@Parameter(names ={"--debug", "-d"}, description = "Enables debug mode", arity = 11)
