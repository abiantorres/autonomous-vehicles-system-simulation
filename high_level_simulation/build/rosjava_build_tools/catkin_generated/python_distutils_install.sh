...
echo_and_run cd "/home/parallels/tfg/autonomous-vehicles-system-simulation/high_level_simulation/src/rosjava_build_tools"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/parallels/tfg/autonomous-vehicles-system-simulation/high_level_simulation/build/rosjava_build_tools" \
    install \
    $DESTDIR_ARG \
