...
struct TestArrays_
{
  ...
  _time_array_type time_array;
   ...
   typedef std::vector< ::rosjava_test_msgs::TestString_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::rosjava_test_msgs::TestString_<ContainerAllocator> >::other >  _test_string_array_type;
